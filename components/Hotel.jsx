...
const HotelPage = () => {
  // Track favorite status for each hotel
  const [favorites, setFavorites] = useState({});
  const navigate = useNavigate();
  // Sample data for multiple hotels
  const hotels = [
    {
      id: 1,
      ...
      amenities: ["Free WiFi", "4K Flat-screen TV", "Spa & Wellness Center"],
    },
    {
      id: 2,
      name: "Beachside Villa",
      description: "A cozy villa right by the beach.",
      price: 180,
      rating: 4.5,
      reviews: 120,
      location: "Miami, Florida",
      image: "https://picsum.photos/500/300?random=11",
      amenities: ["Free WiFi", "Private Pool", "Ocean View"],
    },
    {
      id: 3,
      name: "Mountain Lodge",
      description: "A rustic lodge in the mountains.",
      price: 120,
      rating: 4.2,
      reviews: 80,
      location: "Aspen, Colorado",
      image: "https://picsum.photos/500/300?random=12",
      amenities: ["Free WiFi", "Fireplace", "Hiking Trails"],
    },
  ];

  // Toggle favorite status for a specific hotel
  const toggleFavorite = (hotelId) => {
    setFavorites((prev) => ({
      ...prev,
      [hotelId]: !prev[hotelId], // Toggle the favorite status
    }));
  };
